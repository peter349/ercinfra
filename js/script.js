...
(function ($) {
      ...
      for (var j = 0; j <= digit; j++) {
        elm
          ...
          .css(
            "transform",
            "translateY(-" +
              digit * elm[0].getBoundingClientRect().height +
              "px)"
          );
      }
      elm.addClass("animated");
  ...
  window.bt_bb_countdown = function (elem, selector, i, arr, arr_prev) {
    if (
      arr[i] !== arr_prev[i] ||
      elem.find(selector).children().eq(0).html() == ""
    ) {
      ...
      setTimeout(function () {
        elem
          ...
          .children()
          .eq(1)
          .html(elem.find(selector).children().eq(0).html());
  ...
  window.bt_bb_countdown_output = function (elem) {
    ...
    if (days != days_prev) {
      ...
      elem
        ...
        .html(
          days_html +
            '<span class="days_text"><span>' +
            elem.find(".days").data("text") +
            "</span></span>"
        );
    }
    days_prev = days;
  ...
  function bt_bb_fix_slider_heights() {
    $(".bt_bb_content_slider.bt_bb_height_keep-height .slick-slider").each(
      function (index) {
  ...
  function bt_bb_init_elements() {
    ...
    $(".slick-slider").slick();
    $(
      ".slick-slider .slick-prev, .slick-slider .slick-next, .slick-slider .slick-dots li"
    ).click(function () {
  ...
  window.bt_bb_gmap_init = function (map_id, zoom, custom_style) {
    ...
    locations.each(function () {
      ...
      marker.addListener("click", function () {
        var reload = true;
        if (
          locations.eq(this.count).hasClass("bt_bb_map_location_show") &&
          !container.hasClass("bt_bb_map_no_overlay")
        )
          reload = false;
        container.removeClass("bt_bb_map_no_overlay");
        locations.removeClass("bt_bb_map_location_show");
        if (reload)
          locations.eq(this.count).addClass("bt_bb_map_location_show");
      });
      n++;
    });
    if (center_map) {
  ...
  var map = null;
  window.bt_bb_leaflet_init = function (
    map_id,
    zoom,
    max_zoom,
    predefined_style,
  ...
  window.bt_bb_leaflet_init_late = function (
    map_id,
    zoom,
    max_zoom,
    predefined_style,
    ...
    map = L.map(document.getElementById(map_id)).setView(
    ...
    function markerOnClick(e) {
      ...
      var reload = true;
      if (
        locations.eq(id).hasClass("bt_bb_leaflet_map_location_show") &&
        !container.hasClass("bt_bb_leaflet_map_no_overlay")
      )
        reload = false;
      ...
      if (
        locations.eq(id).hasClass("bt_bb_map_location_show") &&
        !container.hasClass("bt_bb_map_no_overlay")
      )
        reload = false;
      container.removeClass("bt_bb_map_no_overlay");
...
(function ($) {
  $(document).ready(function () {
    $(".bt_bb_fe_count").click(function (e) {
      ...
      if (window != window.top) {
        ...
        $("html, body", window.parent.document).animate(
          {
            scrollTop:
              $(".bt_bb_item_list", window.parent.document)
                .children()
                .eq(order - 1)
                .offset().top -
              $("#wpadminbar", window.parent.document).height(),
          },
          500
        );
      } else {
        if (
          $(this).find(".bt_bb_fe_count_inner").data("edit_url") !== undefined
        ) {
          window.location.replace(
            $(this).find(".bt_bb_fe_count_inner").data("edit_url") +
              "&bt_bb_order=" +
              order
          );
        } else {
          window.location.replace(
            $("#wp-admin-bar-edit .ab-item").attr("href") +
              "&bt_bb_order=" +
              order
          );
        }
    ...
    var bt_bb_fe_preview_toggle = localStorage.getItem(
...
(function ($) {
  ...
  function dd(element, settings) {
    ...
    var _checkDataSetting = function () {
      _settings.mainCSS =
        $("#" + _element).data("maincss") || _settings.mainCSS;
      _settings.visibleRows =
        $("#" + _element).data("visiblerows") || _settings.visibleRows;
      if ($("#" + _element).data("showicon") == false) {
        _settings.showIcon = $("#" + _element).data("showicon");
      }
      _settings.useSprite =
        $("#" + _element).data("usesprite") || _settings.useSprite;
      _settings.animStyle =
        $("#" + _element).data("animstyle") || _settings.animStyle;
      _settings.event = $("#" + _element).data("event") || _settings.event;
      _settings.openDirection =
        $("#" + _element).data("opendirection") || _settings.openDirection;
      _settings.jsonTitle =
        $("#" + _element).data("jsontitle") || _settings.jsonTitle;
      _settings.disabledOpacity =
        $("#" + _element).data("disabledopacity") || _settings.disabledOpacity;
      _settings.childWidth =
        $("#" + _element).data("childwidth") || _settings.childWidth;
      _settings.enableCheckbox =
        $("#" + _element).data("enablecheckbox") || _settings.enableCheckbox;
      _settings.checkboxNameSuffix =
        $("#" + _element).data("checkboxnamesuffix") ||
        _settings.checkboxNameSuffix;
      _settings.append = $("#" + _element).data("append") || _settings.append;
      _settings.prepend =
        $("#" + _element).data("prepend") || _settings.prepend;
    };
    ...
    var _construct = function () {
      ...
      _isList =
        getElement(_element).size > 1 || getElement(_element).multiple == true
          ? true
          : false;
      if (_isList) {
    ...
    var _parseOption = function (opt) {
      ...
      if (opt !== undefined) {
        ...
        if (attrTitle != "") {
          ...
          description =
            isJson && _settings.jsonTitle ? obj[0].description : description;
    ...
    var _createWrapper = function () {
      var obj = { className: _styles.dd + " ddcommon borderRadius" };
    ...
    var _createTitle = function () {
      ...
      if (getElement(_element).selectedIndex >= 0) {
        selectedOption = getElement(_element).options[
      ...
      var oTitle = _createElement("div", {
        className:
          _styles.ddTitle + spriteClass + " " + _styles_i.borderRadiusTp,
      });
      ...
      var oTitleText_in = _createElement(
        "span",
      ...
      var oDescription = _createElement(
        "span",
    ...
    var _childHeight = function (val) {
      ...
      if (getElement(_element).options.length > _settings.visibleRows) {
        var margin =
          parseInt($("#" + childid + " li:first").css("padding-bottom")) +
          parseInt($("#" + childid + " li:first").css("padding-top"));
        if (_settings.rowHeight === 0) {
          $("#" + childid).css({ visibility: "hidden", display: "block" });
          _settings.rowHeight = Math.round(
            $("#" + childid + " li:first").height()
          );
    ...
    var _applyChildEvents = function () {
        ...
        if (_isList === true) {
          if (_isMultiple) {
            if (_shiftHolded === true) {
              ...
              $("#" + childid + " li." + _styles.selected).removeClass(
                _styles.selected
              );
      ...
      $("#" + childid + " li." + _styles.enabled).on("mouseenter", function (
        e
      ) {
        if (_isDisabled === true) return false;
        e.preventDefault();
      ...
      $("#" + childid + " li." + _styles.enabled).on("mouseup", function (e) {
        ...
        _forcedTrigger =
          _oldSelected.length != selected || selected == 0 ? true : false;
    ...
    var _fireAfterItemClicked = function () {
      ...
      if (
        (getElement(_element).selectedIndex != index || _forcedTrigger) &&
        selected.length <= 1
      ) {
        _forcedTrigger = false;
      ...
      if (index !== undefined) {
        ...
        if (index == -1) {
          ...
          if (typeof index != "object") {
            ...
            selectedText =
              index >= 0 ? getElement(_element).options[index].text : "";
            _updateTitleUI(undefined, value);
            value = value.value;
          } else {
            selectedIndex =
              (byvalue && byvalue.index) || getElement(_element).selectedIndex;
    ...
    var _scrollToIfNeeded = function (opt) {
      var childid = _getPostID("postChildID");
      opt =
        opt !== undefined ? opt : $("#" + childid + " li." + _styles.selected);
      if (opt.length > 0) {
    ...
    var _next = function () {
      ...
      var index = $("#" + childid + " li:visible." + _styles_i.li).index(
        selected
      );
      if (index < items.length - 1) {
        ...
        if (index < items.length) {
          if (!_shiftHolded || !_isList || !_isMultiple) {
            $("#" + childid + " ." + _styles.selected).removeClass(
              _styles.selected
            );
          }
    ...
    var _adjustOpen = function () {
      ...
      var contBottom =
        ...
        $("#" + id)
          ...
          .height();
      if (
        contBottom < Math.floor(cH + mH + pos.top) ||
        _settings.openDirection.toLowerCase() == "alwaysup"
      ) {
        top = cH;
        $("#" + childid).css({
          top: "-" + top + "px",
    ...
    var _mergeAllProp = function () {
      ...
      _this.selectedText =
        _orginial.selectedIndex >= 0
          ? _orginial.options[_orginial.selectedIndex].text
          : "";
    ...
    var _getDataAndUIByOption = function (opt) {
      if (opt != null && typeof opt != "undefined") {
        ...
        var ui = $(
          "#" + childid + " li." + _styles_i.li + ":eq(" + opt.index + ")"
        );
    ...
    var _updateTitleUI = function (index, byvalue) {
      ...
      $("#" + titleid)
        .find("." + _styles.description)
        .remove();
      $("#" + titleid)
        .find("." + _styles.label)
        .append(desc);
      getElement(titleid).className =
        _styles.ddTitleText + " " + value.className;
      $("#" + titleid).removeClass("btNotSelected");
      $("#" + titleid)
        .closest(".btContactField")
        .removeClass("btNotSelected");
      if (value.value == "") {
        $("#" + titleid).addClass("btNotSelected");
        $("#" + titleid)
          .closest(".btContactField")
          .addClass("btNotSelected");
      }
    ...
    var _updateUI = function (a, opt, i) {
      ...
      switch (a) {
        case "add":
          ...
          break;
        case "remove":
          wasSelected = $($("#" + childid + " li." + _styles_i.li)[i]).hasClass(
            _styles.selected
          );
          ...
          if (wasSelected == true) {
            if (items.length > 0) {
              ...
              var ind = $("#" + childid + " li." + _styles_i.li).index(
                items[0]
              );
              _setValue(ind);
            }
          ...
          if (
            $("#" + childid + " li." + _styles_i.li).length <
              _settings.visibleRows &&
            !_isList
          ) {
            _childHeight(-1);
    ...
    this.set = function (prop, val) {
      ...
      switch (prop) {
        ...
        case "value":
          getElement(_element)[prop] = val;
          var childid = _getPostID("postChildID");
          $("#" + childid + " li." + _styles_i.li).removeClass(
            _styles.selected
          );
          $(
            $("#" + childid + " li." + _styles_i.li)[
              getElement(_element).selectedIndex
            ]
          ).addClass(_styles.selected);
        ...
        case "length":
          ...
          if (val < getElement(_element).length) {
            ...
            if (val == 0) {
              ...
              $(
                "#" + childid + " li." + _styles_i.li + ":gt(" + (val - 1) + ")"
              ).remove();
              if ($("#" + childid + " li." + _styles.selected).length == 0) {
                $("#" + childid + " li." + _styles.enabled + ":eq(0)").addClass(
                  _styles.selected
                );
              }
            }
    ...
    this.namedItem = function () {
      var opt = getElement(_element).namedItem.apply(
        getElement(_element),
        arguments
      );
    ...
    this.item = function () {
      var opt = getElement(_element).item.apply(
        getElement(_element),
        arguments
      );
      return _getDataAndUIByOption(opt);
...
(window.btModernizr = (function (a, b, c) {
  function C(a) {
    j.cssText = a;
  }
  function D(a, b) {
